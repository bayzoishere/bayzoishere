...
<img src="https://skillicons.dev/icons?i=python,nodejs,js,ts,solidity,bash,linux,docker,git,redis,postgres,mongodb&perline=12" alt="python nodejs js ts solidity bash linux docker git redis postgres mongodb" />
